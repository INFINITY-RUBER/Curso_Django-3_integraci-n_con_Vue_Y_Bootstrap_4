...
class Payment(models.Model):   
    ...
    discount = models.DecimalField(max_digits=10,decimal_places=2, null=True)# 12345678 
    price_discount = models.DecimalField(max_digits=10,decimal_places=2, null=True)# 12345678 
