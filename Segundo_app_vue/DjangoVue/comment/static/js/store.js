...
function changeQuantityEvent() {
  //   changeQuantityMinus = document.querySelectorAll(".changeQuantityMinus");
  document
    .querySelectorAll(".changeQuantityMinus")
    .forEach((changeQuantityMinus) => {
  ...
  document
    .querySelectorAll(".changeQuantityPlus")
    .forEach((changeQuantityPlus) => {
