...
-`python3 -m venv env` entorno viertual
...
crea usuario 'djangouser' y password
-`GRANT ALL ON New_data.* TO 'djangouser'@'%';` dar permiso al usuario en la data base 'New_data'
-`FLUSH PRIVILEGES;`  terminar de dar privilegios a nuevos cambios
...
**8- Registra modelos de admin a la app**
-`python manage.py createsuperuser` crea usuario admin y su clave Ericsson
...
**9- Configura la funcion __str__r** 
`models.py`
```
